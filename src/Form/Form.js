...
function Form() {
  ...
  const {handleChange, handleSubmit, handleBlur, values, touched, errors, isSubmitting} = useFormik({
    initialValues: {loanAmount:"", loanTerm:"",interestRate:"",payBack:"weekly",bsmv:"",kkdv:"" },
    ...
    <div className='main'>
      <div className='formbox'>
        ...
        <div><div>Kredi Tutarı</div><input name='loanAmount' value={values.loanAmount}  onChange={handleChange} placeholder='100.000TL'></input></div>
          ...
          <div><div>Kar Oranı (Aylık)</div><input name='interestRate'value={values.interestRate}  onChange={handleChange} placeholder='1.25%'></input></div>
